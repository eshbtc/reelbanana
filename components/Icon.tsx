...
export const SaveIcon: React.FC<{ className?: string }> = ({ className = "w-5 h-5" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 20 20" fill="currentColor">
        <path d="M7.5 2.5a.5.5 0 00-1 0v3.5a.5.5 0 001 0V2.5zM10 2a1 1 0 00-1 1v3.5a1 1 0 002 0V3a1 1 0 00-1-1zM12.5 2.5a.5.5 0 00-1 0v3.5a.5.5 0 001 0V2.5z" />
        <path fillRule="evenodd" d="M2 5.5A2.5 2.5 0 014.5 3h11A2.5 2.5 0 0118 5.5v9a2.5 2.5 0 01-2.5 2.5h-11A2.5 2.5 0 012 14.5v-9zM4.5 4a1.5 1.5 0 00-1.5 1.5v9a1.5 1.5 0 001.5 1.5h11a1.5 1.5 0 001.5-1.5v-9A1.5 1.5 0 0015.5 4h-11z" clipRule="evenodd" />
    </svg>
);
