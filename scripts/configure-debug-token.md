...
To enable E2E testing with the debug token `A767DE56-7486-4A78-8073-0156488A5007`, you need to configure it in the Firebase Console.
...
3. **Add Debug Token**
   ...
   - Enter the token: `A767DE56-7486-4A78-8073-0156488A5007`
